...
public enum BaseResponseCode implements ResponseCodeInterface{
    ...
    CAPTCHA_NOT_NULL(4010099,"验证码不能为空"),
    CAPTCHA_EXPIRED(4010099,"验证码已过期，请刷新"),
    CAPTCHA_INCORRECT(4010099,"验证码不正确"),
    ...
    UPLOAD_FILE_ERROR(4000012,"上传文件失败"),
    FILE_TOO_LARGE(4000012, "上传的文件大小超出限制"),
    ;

package com.yingxue.lesson.contants;
...
public class Constant {
     ...
     * 存入redis验证码的key
     */
    public static final String CAPTCHA_KEY="captcha-key_";

    /**
     * 返回给前端的验证码标识
     */
    public static final String CAPTCHA_ID="captcha-id";
     ...
     * 验证码验证次数
     */
    public static final String CAPTCHA_COUNT="captcha-count_";
}

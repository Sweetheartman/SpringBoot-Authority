 ...
 * @description: 轮播图控制层
 * @author: lidekun
 * @create: 2020-08-31 17:43
 **/
@RestController
@RequestMapping("/api")
@Api(tags = "轮播图模块", description = "轮播图相关接口")
public class RotationChartController {
    ...
    @MyLog(title = "轮播图模块", action = "分页获取轮播图信息接口")
    @RequiresPermissions(value = "sys:rotation:list")
    ...
    @MyLog(title = "轮播图模块", action = "新增轮播图接口")
    ...
    @MyLog(title = "轮播图模块", action = "轮播图后端编辑接口")
    ...
    @MyLog(title = "轮播图模块", action = "删除轮播图接口")
    ...
    @MyLog(title = "轮播图模块", action = "轮播图前端展现接口")
